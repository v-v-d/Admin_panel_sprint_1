...
1. Сначала необходимо инициализировать бд постргес
```shell
sudo docker-compose up db
```
2. После успешной инициализации бд необходимо запустить скрипт выгрузки данных
```shell
sudo docker-compose up etl
```
